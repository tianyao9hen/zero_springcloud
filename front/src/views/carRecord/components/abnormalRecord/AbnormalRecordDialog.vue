<template>
    <dialog-template ref="abnormalRecordDialog"
                     :is-show-title="false"
        ...
        data(){
            return {
                ...
                recordData: {
                    ...
                    isInvoice: 1,
                    isInvoiceName: '否',
                    exitAccessRoad: 'ck001',
                    exitAccessRoadName: '出口车道001',
        ...
        methods: {
            initDialog(data){
                ...
                this.$nextTick(() => {
                    ...
                    this.$refs.abnormalRecordDialog.show();
                })
            },
            getTableData(){
                this.tableData = [{
            ...
            getExitData(){
                this.exitData = [
                    ...
                    {
                        title: '出场车道编号：',
                        value: this.recordData.exitAccessRoadName,
                    },
                    {
                        title: '出场口编号：',
                        value: this.recordData.exitAccessGateName,
                    },
                    {
                        title: '停车时长：',
